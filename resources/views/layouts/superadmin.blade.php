...
<head>
    ...
    <!-- Framework Scripts Integrations -->
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-brand .brand-text small {
            color: rgba(255,255,255,0.6); font-size: 11px; font-weight: 500; margin-top: 3px;
        ...
        .nav-badge {
            margin-left: auto; background: var(--accent); color: #FFFFFF;
        ...
        .form-control { 
            ...
            font-family: 'Plus Jakarta Sans', sans-serif; background: #f8fafc; color: var(--text-dark);
        }
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('superadmin.dashboard') }}" class="{{ request()->routeIs('superadmin.dashboard') ? 'active' : '' }}">
                    <div class="nav-icon"><i class="fas fa-chart-pie"></i></div> <span>Dashboard</span>
                </a>
            </div>

            <div class="nav-section-title">Manajemen Master</div>
            <div class="nav-item">
                <a href="{{ route('superadmin.admin.index') }}" class="{{ request()->routeIs('superadmin.admin.*') ? 'active' : '' }}">
                    <div class="nav-icon"><i class="fas fa-user-shield"></i></div> <span>Kelola Admin</span>
            ...
            <div class="nav-item">
                <a href="{{ route('superadmin.pelatihan.index') }}" class="{{ request()->routeIs('superadmin.pelatihan.*') ? 'active' : '' }}">
                    <div class="nav-icon"><i class="fas fa-graduation-cap"></i></div> <span>Kelola Pelatihan</span>
            ...
            <div class="nav-item">
                <a href="{{ route('superadmin.user.index') }}" class="{{ request()->routeIs('superadmin.user.*') ? 'active' : '' }}">
                    <div class="nav-icon"><i class="fas fa-users-viewfinder"></i></div> <span>Semua User</span>
                </a>
            </div>
        </nav>
        ...
        <div class="sidebar-footer">
            <div class="user-info">
                ...
                <div class="user-details">
                    ...
                    <small><i class="fas fa-circle text-success" style="font-size: 8px;"></i> Aktif</small>
                </div>
            </div>
    ...
    <div class="topbar">
        <div class="topbar-title">
            ...
            <div class="topbar-title-text">
                ...
                <small>@yield('page-subtitle', 'Super Admin Control Panel Suite')</small>
            </div>
        </div>
        <div class="topbar-badge">
            <i class="fas fa-key"></i> <span>Hak Akses Superadmin</span>
        </div>
    </div>
