...
<div style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:40px;text-align:center;color:#718096;margin-bottom:20px">
    <i class="fas fa-list" style="font-size:36px;opacity:0.3;display:block;margin-bottom:12px"></i>
    <p style="font-size:14px">Belum ada materi untuk pelatihan ini.</p>
</div>
@elseif($peserta->isEmpty())
<div style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;padding:40px;text-align:center;color:#718096;margin-bottom:20px">
    <i class="fas fa-users" style="font-size:36px;opacity:0.3;display:block;margin-bottom:12px"></i>
    <p style="font-size:14px">Belum ada peserta terdaftar di pelatihan ini.</p>
</div>
@else
...
<div class="dashboard-card mb-5">
    <div class="card-body p-4 p-md-5">
        ...
        <div class="d-flex align-items-center mb-4">
            <div>
                <h5 class="fw-bold mb-1" style="color: #0f172a;">Observasi Materi</h5>
                <p class="text-muted mb-0" style="font-size: 0.875rem;">Kelola dan catat hasil observasi peserta pada setiap sesi materi.</p>
            </div>
        </div>
